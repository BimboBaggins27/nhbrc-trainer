...
🔄 **Government Gazette — Subordinate Legislation index** — content changed (Δ -65 bytes, 35→30 keyword hits)
   https://www.gov.za/documents/notices?keys=building+regulations
🔄 **SABS Webstore — SANS 10400 catalogue** — content changed (Δ +56 bytes, 63→63 keyword hits)
   https://store.sabs.co.za/sans-10400-the-application-of-the-national-building-regulations
🔄 **Engineering News — construction tag** — content changed (Δ -3,068 bytes, 0→0 keyword hits)
