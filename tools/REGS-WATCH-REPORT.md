# Regulations watch — 2026-07-13

Sources scanned: 7. Detected 6 change(s), 0 error(s).
...
🔄 **Government Gazette — Subordinate Legislation index** — content changed (Δ -1,590 bytes, 30→33 keyword hits)
   https://www.gov.za/documents/notices?keys=building+regulations
🔄 **SABS Webstore — SANS 10400 catalogue** — content changed (Δ -1,020 bytes, 63→63 keyword hits)
   https://store.sabs.co.za/sans-10400-the-application-of-the-national-building-regulations
🔄 **Engineering News — construction tag** — content changed (Δ +3,319 bytes, 0→0 keyword hits)
   https://www.engineeringnews.co.za/page/construction
🔄 **Cape Town building plans page (LA reference)** — content changed (Δ +26,621 bytes, 0→0 keyword hits)
